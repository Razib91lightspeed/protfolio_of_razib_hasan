    ...
    <section id="contact" className="section py-20">
      ...
      <div className="mt-10 grid md:grid-cols-2 gap-10 items-center">
        <div className="relative w-full aspect-[4/3]">
          <Image src="/images/about.png" alt="About" fill className="object-cover rounded-2xl" />
        </div>
        <form
          ...
          className="space-y-4"
        >
          <input name="name" placeholder="Your Name" required className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 outline-none" />
          <input type="email" name="email" placeholder="Your Email" required className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 outline-none" />
